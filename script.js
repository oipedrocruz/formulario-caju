...
const message = {
  ...
  ['valTrabalho']: "* Área que você trabalha é obrigatório",
  ['cargo']: "* Cargo é obrigatório",
  ['empresa']: "* Empresa é obrigatório",
  ['colaboradores']: "* Colaboradores é obrigatório",
  ['valDesafio']: "* Seu desafio é obrigatório",
}
...
const validadorInputs = (input, container, errorElement) => {
  ...
  if (input.id === "email" && !validateEmail(input.value)) { // input
    ...
    container.classList.add('form__error-err')
    errorElement.textContent = "* Telefone é obrigatório"
    errorElement.style.display = "block"
    isValid = true
